...
var money = 1000;
var health = randint(95,100);
var morale = randint(75,100);
var intellect = randint(45,85);
var looks = randint(60,95);
var karma = 0;
var isStudent = false;
...
function profile(){
	...
	for (x=0;x!=USER.assets.length;x++){
		...
		assets_worth += asset[1];
	}
	var net_worth = (money + BANK.balance + assets_worth) - BANK.loan;
	...
	Net Worth - <b class="w3-text-green">${net_worth}$</b><br>
	`;
	if (student_has_loan){
...
function depression(){
	...
	let html = `
	<br> Depression has struck another human but this time ,
	it's you.<br>
	You have been having some harsh time these days which
	have caused you to become depressed.<br>
	`;
	Swal.fire({
		icon:"warning",
...
function settings(){
	...
	<br><br>
	<button onclick="display_themes()" class="w3-btn w3-blue">Display Themes</button>
	<br><br>
	<hr><br>
...
function display_themes(){
	...
	let html = `
	<br><br>
	<button onclick="dark_mode()" class="w3-btn w3-dark-grey">Dark Mode</button>
	<br><br>
	<button onclick="ultra_dark_mode()" class="w3-btn w3-black">Ultra Dark Mode</button>
	<br><br>
	<button onclick="light_mode()" class="w3-btn w3-pale-blue">Light Mode</button>
	<br><br>
	<button onclick="cobalt_mode()" class="w3-btn w3-blue">Cobalt Mode</button>
	<br><br>
	<button onclick="blood_mode()" class="w3-btn w3-red">Blood Mode</button>
	<br><br>
	<button onclick="wizard_mode()" class="w3-btn w3-purple">Wizard Mode</button>
...
function light_mode(){
	$("body").css("background-color","#f0dfdb");
	$("body").css("color","black");
}

function cobalt_mode(){
...
function blood_mode(){
	$("body").css("background-color","#a40319");
	$("body").css("color","white");
}
