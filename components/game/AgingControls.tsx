...
export function AgingControls() {
  ...
  // Always show the actual speed setting, never "Paused"
  const displaySpeed = currentSpeed === 'paused' ? 'normal' : currentSpeed;
